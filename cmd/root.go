...
func ExecuteAction(wg *sync.WaitGroup, ctx context.Context, action string) error {
	...
	cleanUp(wg, ctx, mpdClient)
	return nil
}

func Run(wg *sync.WaitGroup, ctx context.Context) error {
